...
pdeSolver::pdeSolver(const Json::Value jroot)
    : m_nx(jroot["mesh"]["nx"].asInt()), m_ny(jroot["mesh"]["ny"].asInt()),
      m_left(jroot["boundary_conditions"]["left"].asDouble()),
      m_right(jroot["boundary_conditions"]["right"].asDouble()),
      m_top(jroot["boundary_conditions"]["top"].asDouble()),
      m_bottom(jroot["boundary_conditions"]["bottom"].asDouble()),
      m_source(jroot["boundary_conditions"]["source"].asDouble()),
...
void pdeSolver::set_boundary_conditions(const double left, const double right,
...
vector<vector<double>> pdeSolver::get_results() { return m_temperature_values; }
